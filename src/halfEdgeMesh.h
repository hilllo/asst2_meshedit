   ...
   */
   ...
   class HalfedgeMesh
   {
      public:
         ...
         VertexIter   collapseEdge( EdgeIter e , bool ds); ///< split an edge, returning a pointer to the inserted midpoint vertex; the halfedge of this vertex should refer to one of the edges in the original mesh
